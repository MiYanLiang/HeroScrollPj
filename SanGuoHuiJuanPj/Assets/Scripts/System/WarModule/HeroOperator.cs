...
namespace Assets.System.WarModule
{
    ...
    /// <summary>
    /// 74 红颜 随机选择1|3|5个武将士兵单位，有概率（10+智力差/10）%对其添加【魅惑】状态1回合
    /// </summary>
    ...
    /// <summary>
    /// 87 权臣 随机选择1|3|5个武将士兵单位，有概率（10+智力差/10）%对其添加【弃战】状态1回合
    /// </summary>
    ...
    public class YiShiOperator : HeroOperator
    {
        ...
        protected virtual int Healing() => (int)(StateDamage() * (StateIntelligent() / 50f));
